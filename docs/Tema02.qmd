...
- ¿Qué trimestres superan 160 en ventas?
  ...
  - formato ancho: imposible (tarea manual difícil con muchas fechas)
...
- Gráfico temporal
  ...
  - en formato ancho: añadir cada tienda manualmente (no escala: ¿y si tengo 50 tiendas?)
...
- Problemas prácticos con formato ancho para analizar datos:
  ...
  1. Algunas tareas son imposibles
  
  2. Código repetitivo y propenso a errores

  3. No escala: con 12 meses o 50 tiendas se vuelve inmanejable
  
:::  

::::{.notes}

   1. Ej.: No puedes usar `filter()` sobre valores que están en columnas

   2. (si añado Q5, debo modificar múltiples líneas),

   3. Incompatible con ggplot2: ggplot2 espera formato largo   
   
**Cuándo Usar Cada Formato**

- **LARGO**: Para análisis con `dplyr` y `ggplot2`
- **ANCHO**: Solo para tablas de presentación final
...
# Presentar en ancho para ejecutivos
